...
folder are mapped to the application's root namespace, 'Cryptic'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Cryptic' in the same way
as `"Cryptic/sass/src"`.
