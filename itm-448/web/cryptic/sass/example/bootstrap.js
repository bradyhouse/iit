...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.util.Positionable_ext": "../../../ext/src/util/Positionable_ext.js",
...
Ext.ClassManager.addNameAlternateMappings({
  "Cryptic.Application": [],
  "Cryptic.controller.Root": [],
  "Cryptic.controller.content.passphrases.PassPhrasesController": [],
  "Cryptic.controller.content.passphrases.mixin.PassPhrases": [],
  "Cryptic.controller.content.passphrases.mixin.decrypt.Decrypt": [],
  "Cryptic.controller.content.passphrases.mixin.decrypt.DecryptPassPhrase": [],
  "Cryptic.controller.content.passphrases.mixin.encrypt.Encrypt": [],
  "Cryptic.controller.content.passphrases.mixin.encrypt.EncryptPassPhrase": [],
  "Cryptic.controller.content.platform.PlatformController": [],
  "Cryptic.controller.content.platform.mixin.Cloud": [],
  "Cryptic.controller.content.platform.mixin.Local": [],
  "Cryptic.controller.content.platform.mixin.Platform": [],
  "Cryptic.controller.content.postprocess.PostProcessController": [],
  "Cryptic.controller.content.postprocess.mixin.Download": [],
  "Cryptic.controller.content.postprocess.mixin.NextFile": [],
  "Cryptic.controller.content.postprocess.mixin.PostProcess": [],
  "Cryptic.controller.content.processes.ProcessesController": [],
  "Cryptic.controller.content.processes.mixin.Processes": [],
  "Cryptic.controller.content.processes.mixin.pick.decrypt.Continue": [],
  "Cryptic.controller.content.processes.mixin.pick.decrypt.GoogleDrive": [],
  "Cryptic.controller.content.processes.mixin.pick.decrypt.Local": [],
  "Cryptic.controller.content.processes.mixin.pick.decrypt.PickFile": [],
  "Cryptic.controller.content.processes.mixin.pick.encrypt.Continue": [],
  "Cryptic.controller.content.processes.mixin.pick.encrypt.GoogleDrive": [],
  "Cryptic.controller.content.processes.mixin.pick.encrypt.Local": [],
  "Cryptic.controller.content.processes.mixin.pick.encrypt.PickFile": [],
  "Cryptic.controller.content.processes.mixin.selecttype.Decrypt": [],
  "Cryptic.controller.content.processes.mixin.selecttype.Encrypt": [],
  "Cryptic.controller.content.processes.mixin.selecttype.SelectType": [],
  "Cryptic.controller.content.provider.ProviderController": [],
  "Cryptic.controller.content.provider.mixin.GoogleDrive": [],
  "Cryptic.controller.content.provider.mixin.Other": [],
  "Cryptic.controller.content.provider.mixin.Provider": [],
  "Cryptic.controller.footer.FooterController": [],
  "Cryptic.controller.header.BreadCrumbsController": [],
  "Cryptic.controller.sidebar.SidebarController": [],
  ...
  "Cryptic.view.center.processes.pick.decrypt.Continue": [],
  "Cryptic.view.center.processes.pick.decrypt.GoogleDrive": [],
  "Cryptic.view.center.processes.pick.decrypt.Local": [],
  "Cryptic.view.center.processes.pick.decrypt.PickFile": [],
  "Cryptic.view.center.processes.pick.encrypt.Continue": [],
  "Cryptic.view.center.processes.pick.encrypt.GoogleDrive": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Cryptic.view.center.passphrases.decrypt.Decrypt": [
    "widget.start-decryption"
  ],
  "Cryptic.view.center.passphrases.decrypt.DecryptPassPhrase": [
    "widget.decrypt-passphrase-panel"
  ],
  "Cryptic.view.center.passphrases.decrypt.PassPhrase": [
    "widget.decryptpassphrase"
  ],
  "Cryptic.view.center.passphrases.encrypt.Encrypt": [
    "widget.start-encryption"
  ],
  "Cryptic.view.center.passphrases.encrypt.EncryptPassPhrase": [
    "widget.encrypt-passphrase-panel"
  ],
  "Cryptic.view.center.passphrases.encrypt.PassPhrase": [
    "widget.encryptpassphrase"
  ],
  "Cryptic.view.center.platform.Cloud": [
    "widget.platform-cloud"
  ],
  "Cryptic.view.center.platform.Local": [
    "widget.platform-local"
  ],
  "Cryptic.view.center.platform.Platform": [
    "widget.platform"
  ],
  ...
  "Cryptic.view.center.postprocess.Subtitle": [
    "widget.postprocess-subtitle"
  ],
  "Cryptic.view.center.processes.Processes": [
    "widget.processes"
  ],
  "Cryptic.view.center.processes.pick.decrypt.Continue": [
    "widget.process-decrypt-continue"
  ],
  "Cryptic.view.center.processes.pick.decrypt.GoogleDrive": [
    "widget.process-decrypt-googledrive"
  ],
  "Cryptic.view.center.processes.pick.decrypt.Local": [
    "widget.process-decrypt-local"
  ],
  "Cryptic.view.center.processes.pick.decrypt.PickFile": [
    "widget.process-decrypt-pickfile"
  ],
  "Cryptic.view.center.processes.pick.encrypt.Continue": [
    "widget.process-encrypt-continue"
  ],
  "Cryptic.view.center.processes.pick.encrypt.GoogleDrive": [
    "widget.process-encrypt-googledrive"
  ],
  "Cryptic.view.center.processes.pick.encrypt.Local": [
    "widget.process-encrypt-local"
  ],
  "Cryptic.view.center.processes.pick.encrypt.PickFile": [
    "widget.process-encrypt-pickfile"
  ],
  "Cryptic.view.center.processes.selecttype.Decrypt": [
    "widget.processes-selecttype-decrypt"
  ],
  "Cryptic.view.center.processes.selecttype.Encrypt": [
    "widget.processes-selecttype-encrypt"
  ],
  "Cryptic.view.center.processes.selecttype.SelectType": [
    "widget.processes-selecttype"
  ],
  "Cryptic.view.center.provider.GoogleDrive": [
    "widget.googledrive"
  ],
...
Ext.setVersion("cryptic-theme", "1.0.0");
Ext.setVersion("ext", "5.0.0.736");
Ext.setVersion("ext-theme-access", "5.0.0");
...
Ext.Loader.loadScriptsSync([
  ...
  "../../../ext/overrides/data/NodeInterface.js"
]);
