$(function(){
	var body = $('body'),
		...
		back = $('a.back');
	/* Step 1 */
	$('#step1 .cloud').click(function(){
		body.attr('class', 'cloud');
       	initPicker();
    });
	$('#step1 .local').click(function(){
		body.attr('class', 'local');
		step(2);
	});
	/* Step 2 */
    ...
    // Init Google Drive File Picker
    function initPicker() {
        var picker = new FilePicker({
            apiKey: 'AIzaSyBx53vTrzLO0h-z1XbErTELfP3E1Smbmis',
            clientId: '204334724477-dc0h7bs73dqpaa9rkbb5s08ea0u2tk9n',
            buttonEl: document.getElementById('cloud'),
            onSelect: function(file) {
