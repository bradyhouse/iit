...
//
$_CONFIG['main_title'] = "Post Explorer";
...
//
$_CONFIG['users'] = array(array('test','test','admin'));
...
//
$_CONFIG['upload_allow_type'] = array("text/plain");
...
//
$_CONFIG['upload_reject_extension'] = array("php", "js", "html");
...
//
$_CONFIG['upload_email'] = "bradyhouse@gmail.com";
...
class FileManager
{
	...
	*/
	...
	function uploadFile($location, $userfile)
	{
		...
		$name = strval(FileManager::to_epoch_time($now)).'_'.basename($userfile['name']);
