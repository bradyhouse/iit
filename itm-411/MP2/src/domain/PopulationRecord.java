...
public class PopulationRecord extends Record {
    ...
    public PopulationRecord(String[] csv)
    {
        ...
        SumLevCode sumlev = SumLevCode.NA;
        
        switch(Integer.parseInt(csv[0]))
        {
            case 10:
                sumlev = SumLevCode.Nation;
                break;
            case 20:
                sumlev = SumLevCode.Region;
                break;
            case 40:
                sumlev = SumLevCode.State;
        } // end switch
        
        this.setSumlev(sumlev);
        this.setRegion(csv[1]);
        this.setDivision(csv[2]);
        this.setState(Integer.parseInt(csv[3]));
        String name = csv[4];
        this.setName(name);
