...
public class PersistentObject implements Serializable, 
        domain.CollectionAnalytics {

    
    
    private ArrayList<domain.PopulationRecord> m_col_populationRecords;
    ...
    {
        this.m_dte_date = new Date();
        this.m_col_populationRecords = new ArrayList<domain.PopulationRecord>();
    ...
    */
	...
	for(PopulationRecord rec : m_col_populationRecords)
        ...
        for(PopulationRecord rec : m_col_populationRecords)
        {
            if(rec.getState()!=domain.Record.StateFIPCode.NA)
