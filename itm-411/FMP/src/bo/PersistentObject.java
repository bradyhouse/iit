...
public class PersistentObject implements Serializable, 
    ...
    {
    	this.m_col_populationRecords = new ArrayList<bo.PopulationRecord>();
    ...
    /**
     * Control function used to populate the
     * PopulationRecord collection using a Vector.
     * 
     * @param data Vector containing the Population records to be
     * added.
     */
    public synchronized void LoadVector(Vector data)
    {
    	for(Object row : data)
    	{
    		final PopulationRecord rec = (PopulationRecord)row;
    		final String recstr = rec.toString();
    		
    		String[] values = recstr.split(",");
    		PopulationRecord cpy = new PopulationRecord(values);
    		
    		this.m_col_populationRecords.add(cpy);
    	} // end:for
    } // end:LoadVector
    ...
    */
	...
	for(PopulationRecord rec : m_col_populationRecords)
        ...
        return m_col_populationRecords.get(0).getState();
