...
/**
 * Class used to virtualize Commandline argments.
 * 
 */
public class Argument {
	...
	/**
	 * Overloaded constructor, which accepts the keyValuePair having the format:
	 * key=value
	 * 
	 * @param keyValuePair
	 *            string value containing the key and value delimited by an
	 *            equal character.
	 */
