 ...
 * config.xml file for MySql Database creation details.
 * 
 */
public class XmlMySqlDatabaseParseHandler extends
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (this.isMyElement(qName, attributes)
				&& qName.equalsIgnoreCase("EntityName")) {
	...
	public void characters(char[] ch, int start, int length)
			throws SAXException {
		if (this.isMyElement() && this.m_boo_parseName
