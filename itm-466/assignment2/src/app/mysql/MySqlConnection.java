...
/**
 * Wrapper class for a MySQL Server connection.
 * 
 */
public class MySqlConnection {
	private String m_str_server, m_str_database, m_str_username,
			m_str_password, m_str_portNumber;
	...
	/**
	 * Overloaded constructor that can be used to assign the defining attributes
	 * of the connection during initialization of the class.
	 * 
	 * @param server
	 *            string value equal to the target SQL Server
	 * @param database
	 *            string value equal to the target database
	 * @param username
	 *            string value equal to the user name to use for the connection
	 * @param password
	 *            string value equal to the password to use for the connection
	 */
	public MySqlConnection(String server, String database, String port,
	 ...
	 * 
	 * @param type
	 *            string value equal to target enum Entity Type
	 */
	...
	public boolean test() {
		...
		try {
			...
			String _url = "jdbc:mysql://" + this.m_str_server + ":"
					+ this.m_str_portNumber + "/" + this.m_str_database;
			// / Try establishing a connection
			Connection _connection = DriverManager.getConnection(_url,
					this.m_str_username, this.m_str_password);
	...
	public Connection getConnection() throws SQLException {
		...
		try {
			...
			String _url = "jdbc:mysql://" + this.m_str_server + ":"
					+ this.m_str_portNumber + "/" + this.m_str_database;
			// / Try establishing a connection
			_conn = DriverManager.getConnection(_url, this.m_str_username,
					this.m_str_password);
	...
	public String toString() {
		return "jdbc:mysql://" + this.m_str_server + ":"
				+ this.m_str_portNumber + "/" + this.m_str_database;
	}
