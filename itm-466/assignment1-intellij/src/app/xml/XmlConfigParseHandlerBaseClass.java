 ...
 * common to Config file parsers. All class
 * that extend from this base class should
 * provide implementation for the SAX
...
public abstract class XmlConfigParseHandlerBaseClass extends DefaultHandler {
    ...
    protected boolean isMyElement(String qName, Attributes attributes) {
        if (qName.equalsIgnoreCase("configuration") && attributes.getValue("id").equalsIgnoreCase(this.getId())) {
    ...
    /**
     * Enumeration defining the Elements
     * comprising the config.xml file.
     */
    ...
    /**
     * Enumeration defining template types
