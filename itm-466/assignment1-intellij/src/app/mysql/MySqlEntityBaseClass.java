...
/**
 * Base class that defines the attributes
 * common to all MySql Entity objects.
 *
...
public abstract class MySqlEntityBaseClass {
    ...
    /**
     * Overloaded constructor which can be used to initialize the
     * attributes of the class when the class is constructed.
     *
     * @param connection mysql connection class instance
     * @param name       string value
     * @param xsdFile    string xsd file name and path
     * @param xmlFile    string xml file name and path
     */
    public MySqlEntityBaseClass(MySqlConnection connection, String name, String xsdFile, String xmlFile) {
    ...
    /**
     * Overloaded constructor used to initialize the a
     * connection object and a name attribute.
     *
     * @param connection
     * @param name
     */
     ...
     * to return the name of the entity and the
     * details of the entity's database connection.
     */
    @Override
    public String toString() {
        return "Entity Name: " + this.m_str_name + "\n" +
                "Connection String: " + this.m_cls_connection.toString();
    }
}
