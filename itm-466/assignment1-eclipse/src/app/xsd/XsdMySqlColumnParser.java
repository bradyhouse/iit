...
public class XsdMySqlColumnParser extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equalsIgnoreCase("xs:element")) {
            ...
            if (_xsdTypeValue != null && _xsdNameValue != null) {
                String _parsedTypeValue = this.parseType(attributes.getValue("type"));
                this.m_cls_column = new MySqlColumn(_xsdNameValue, _parsedTypeValue, (m_int_columnIndex + 1));
            }
        }
    }
    /** {@inheritDoc} */
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("xs:element") && this.m_cls_column != null) {
            this.m_map_dataColumns.put(this.m_int_columnIndex, this.m_cls_column);
